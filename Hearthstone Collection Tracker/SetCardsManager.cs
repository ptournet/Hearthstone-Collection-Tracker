...
namespace Hearthstone_Collection_Tracker
{
    ...
    {
        public static readonly string[] CollectableSets = { "Classic", "Goblins vs Gnomes", "The Grand Tournament", "Whispers of the Old Gods", "Mean Streets of Gadgetzan", "Journey to Un'Goro", "Knights of the Frozen Throne", "Kobolds and Catacombs", "The Witchwood" };

        public static readonly string[] StandardSets = { "Classic", "Journey to Un'Goro", "Knights of the Frozen Throne", "Kobolds and Catacombs", "The Witchwood" };
